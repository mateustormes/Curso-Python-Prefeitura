...
home = ImageTk.PhotoImage(Image.open('fogo.png').resize((40,40),Image.ANTIALIAS))
settings = ImageTk.PhotoImage(Image.open('fogo.png').resize((40,40),Image.ANTIALIAS))
ring = ImageTk.PhotoImage(Image.open('fogo.png').resize((40,40),Image.ANTIALIAS))
